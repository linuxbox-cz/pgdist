...
python "${PATH_PGDIST_SRC}/pgdist.py" add "${PATH_SCHEMAS}/d2_schema_1.sql" -c $PATH_CONFIG_1

log_pgdist "add ${PATH_TABLES}/d2_table_1.sql"
python "${PATH_PGDIST_SRC}/pgdist.py" add "${PATH_TABLES}/d2_table_1.sql" -c $PATH_CONFIG_1

log_pgdist "add ${PATH_INDEXES}/d2_index_1.sql"
python "${PATH_PGDIST_SRC}/pgdist.py" add "${PATH_INDEXES}/d2_index_1.sql" -c $PATH_CONFIG_1
...
python "${PATH_PGDIST_SRC}/pgdist.py" role-change pgdist_test_role_1 login password -c $PATH_CONFIG_1

log_pgdist "role-change pgdist_test_role_2 nologin "
python "${PATH_PGDIST_SRC}/pgdist.py" role-change pgdist_test_role_2 nologin -c $PATH_CONFIG_1
...
python "${PATH_PGDIST_SRC}/pgdist.py" create-update v1.0 1.1 -c $PATH_CONFIG_1
...
cd $PATH_SQL
python "${PATH_PGDIST_SRC}/pgdist.py" test-update v1.0 1.1 -c $PATH_CONFIG_1
