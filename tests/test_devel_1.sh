...
python "${PATH_PGDIST_SRC}/pgdist.py" init pgdist_test_project "${PATH_PROJECT}/" -c $PATH_CONFIG_DEV

#create pgdist schema
log_pgdist "create-schema pgdist_test_schema"
cd $PATH_SQL
python "${PATH_PGDIST_SRC}/pgdist.py" create-schema pgdist_test_schema -c $PATH_CONFIG_DEV
...
log_pgdist "status"
cd $PATH_SQL
python "${PATH_PGDIST_SRC}/pgdist.py" status -c $PATH_CONFIG_DEV
...
python "${PATH_PGDIST_SRC}/pgdist.py" add "${PATH_TABLES}/d1_table_1.sql" "${PATH_TABLES}/d1_table_2.sql" -c $PATH_CONFIG_DEV

log_pgdist "status"
python "${PATH_PGDIST_SRC}/pgdist.py" status -c $PATH_CONFIG_DEV

log_pgdist "rm ${PATH_TABLES}/d1_table_1.sql ${PATH_TABLES}/d1_table_2.sql"
python "${PATH_PGDIST_SRC}/pgdist.py" rm "${PATH_TABLES}/d1_table_1.sql" "${PATH_TABLES}/d1_table_2.sql" -c $PATH_CONFIG_DEV
...
python "${PATH_PGDIST_SRC}/pgdist.py" add "${PATH_SCHEMAS}/d1_schema_1.sql" "${PATH_TABLES}/d1_table_1.sql" "${PATH_TABLES}/d1_table_2.sql" "${PATH_FUNCTIONS}/d1_function_1.sql" -c $PATH_CONFIG_DEV
...
python "${PATH_PGDIST_SRC}/pgdist.py" add "${PATH_INDEXES}/d1_index_1.sql" "${PATH_CONSTRAINTS}/d1_constraint_1.sql" "${PATH_TRIGGERS}/d1_trigger_1.sql" "${PATH_VIEWS}/d1_view_1.sql" "${PATH_DATA}/d1_data_1.sql" -c $PATH_CONFIG_DEV
...
python "${PATH_PGDIST_SRC}/pgdist.py" role-add pgdist_test_role_1 nologin -c $PATH_CONFIG_DEV

log_pgdist "role-list"
python "${PATH_PGDIST_SRC}/pgdist.py" role-list -c $PATH_CONFIG_DEV

log_pgdist "role-rm pgdist_test_role_1"
python "${PATH_PGDIST_SRC}/pgdist.py" role-rm pgdist_test_role_1 -c $PATH_CONFIG_DEV

log_pgdist "role-list"
python "${PATH_PGDIST_SRC}/pgdist.py" role-list -c $PATH_CONFIG_DEV

log_pgdist "role-add pgdist_test_role_1 login password"
python "${PATH_PGDIST_SRC}/pgdist.py" role-add pgdist_test_role_1 login password -c $PATH_CONFIG_DEV
...
python "${PATH_PGDIST_SRC}/pgdist.py" role-add pgdist_test_role_2 login password -c $PATH_CONFIG_DEV

#set and get dbparam
log_pgdist "dbparam-set OWNER pgdist_test_role_1"
python "${PATH_PGDIST_SRC}/pgdist.py" dbparam-set OWNER pgdist_test_role_1 -c $PATH_CONFIG_DEV

log_pgdist "dbparam-get"
python "${PATH_PGDIST_SRC}/pgdist.py" dbparam-get -c $PATH_CONFIG_DEV
...
python "${PATH_PGDIST_SRC}/pgdist.py" require-add pgdist_test_project_2 https://github.com/TadeasPopov/pgdist_test_project.git master -c $PATH_CONFIG_DEV

log_pgdist "require-rm pgdist_test_project_2"
python "${PATH_PGDIST_SRC}/pgdist.py" require-rm pgdist_test_project_2 -c $PATH_CONFIG_DEV

if [ "$GIT_USER" -a "$GIT_EMAIL" ]; then
    log_pgdist "require-add pgdist_test_project_2 git@git.linuxbox.cz:tpopov/pgdist_tester.git master"
    python "${PATH_PGDIST_SRC}/pgdist.py" require-add pgdist_test_project_2 git@git.linuxbox.cz:tpopov/pgdist_tester.git master -c $PATH_CONFIG_DEV
fi

#add some data
log_pgdist "data-add pgdist_test_schema.test_table_1"
python "${PATH_PGDIST_SRC}/pgdist.py" data-add pgdist_test_schema.test_table_1 id -c $PATH_CONFIG_DEV

log_pgdist "data-list"
python "${PATH_PGDIST_SRC}/pgdist.py" data-list -c $PATH_CONFIG_DEV

log_pgdist "data-rm pgdist_test_schema.test_table_1"
python "${PATH_PGDIST_SRC}/pgdist.py" data-rm pgdist_test_schema.test_table_1 -c $PATH_CONFIG_DEV
...
cd $PATH_PROJECT
python "${PATH_PGDIST_SRC}/pgdist.py" test-load -c $PATH_CONFIG_DEV

#create version 1.0
log_pgdist "create-version 1.0"
cd $PATH_SQL
python "${PATH_PGDIST_SRC}/pgdist.py" create-version 1.0 -c $PATH_CONFIG_DEV
