...
log_pgdist "list"
python "${PATH_PGDIST_SRC}/pgdist.py" list -c $PATH_CONFIG_MNG $PGCONN_2
...
python "${PATH_PGDIST_SRC}/pgdist.py" install pgdist_test_project pgdist_test_database -c $PATH_CONFIG_MNG $PGCONN_2
...
python "${PATH_PGDIST_SRC}/pgdist.py" check-update pgdist_test_project pgdist_test_database -c $PATH_CONFIG_MNG $PGCONN_2

log_pgdist "update pgdist_test_project pgdist_test_database 1.1"
python "${PATH_PGDIST_SRC}/pgdist.py" update pgdist_test_project pgdist_test_database 1.1 -c $PATH_CONFIG_MNG $PGCONN_2
...
python "${PATH_PGDIST_SRC}/pgdist.py" pgdist-update pgdist_test_database -c $PATH_CONFIG_MNG $PGCONN_2

log_pgdist "set-version pgdist_test_project pgdist_test_database 2.0"
python "${PATH_PGDIST_SRC}/pgdist.py" set-version pgdist_test_project pgdist_test_database 2.0 -c $PATH_CONFIG_MNG $PGCONN_2
