...
log_pgdist "list"
python "${PATH_PGDIST_SRC}/pgdist.py" list -c $PATH_CONFIG_2
...
python "${PATH_PGDIST_SRC}/pgdist.py" install pgdist_test_project pgdist_test_database -c $PATH_CONFIG_2
...
python "${PATH_PGDIST_SRC}/pgdist.py" diff-db "${PGCONN}pgdist_test_database" -c $PATH_CONFIG_1

#update db project
log_pgdist "check-update pgdist_test_project pgdist_test_database"
python "${PATH_PGDIST_SRC}/pgdist.py" check-update pgdist_test_project pgdist_test_database -c $PATH_CONFIG_2

log_pgdist "update pgdist_test_project pgdist_test_database 1.1"
python "${PATH_PGDIST_SRC}/pgdist.py" update pgdist_test_project pgdist_test_database 1.1 -c $PATH_CONFIG_2
...
python "${PATH_PGDIST_SRC}/pgdist.py" diff-db $PGCONN -c $PATH_CONFIG_1

log_pgdist "diff-db-file ${PGCONN} '${PATH_SQL}/pg_project.sql'"
python "${PATH_PGDIST_SRC}/pgdist.py" diff-db-file "${PGCONN}" "${PATH_SQL}/pg_project.sql" -c $PATH_CONFIG_1

log_pgdist "diff-file-db '${PATH_SQL}/pg_project.sql' ${PGCONN}"
python "${PATH_PGDIST_SRC}/pgdist.py" diff-file-db "${PATH_SQL}/pg_project.sql" $PGCONN -c $PATH_CONFIG_1

log_pgdist "list"
python "${PATH_PGDIST_SRC}/pgdist.py" list -c $PATH_CONFIG_2

log_pgdist "pgdist-update pgdist_test_database"
python "${PATH_PGDIST_SRC}/pgdist.py" pgdist-update pgdist_test_database -c $PATH_CONFIG_2

log_pgdist "set-version pgdist_test_project pgdist_test_database 2.0"
python "${PATH_PGDIST_SRC}/pgdist.py" set-version pgdist_test_project pgdist_test_database 2.0 -c $PATH_CONFIG_2
